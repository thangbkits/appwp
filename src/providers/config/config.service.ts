...
if (localStorage.languageCode == undefined) {
  localStorage.languageCode = "vi"; //default language code
...
export class ConfigService {
  ...
  public url: string = 'https://app.webwp.vn';
  public consumerKey: string = 'ck_3623e4a211008e90a4cf9432667bfe8541599861';
  public consumerSecret: string = 'cs_4d8e6f40d56b1c0617428a72049ed1a6b57db1ab';
  ...
  public currentCate = "tabs/categories";
  ...
  getOptions() {
    const url = 'https://app.webwp.vn/wp-json/acf/v3/options/options';
